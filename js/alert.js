...
var body = document.getElementsByTagName('body')[0];
    ...
    <div class="con">
        <div id="msg">
            ...
            <a href="javascript:void(0)"; onclick="clearmsg()" id="alertSure" class="button button--bird">
    ...
    //     msg.style.opacity = 1
    // } else if(pay.style.opacity ==1){
    //     msg.style.opacity = 0
    // }
    
    document.addEventListener("keydown",function fn(event) {
        if(event.key === "Enter"){
            clearmsg();
        }
...
function clearmsg(){
    ...
    // msg.remove();shi
    // con.remove();
    if(msg.hidden == false&&con.hidden == false){
        msg.hidden = true;
        con.hidden = true;
    }
};
